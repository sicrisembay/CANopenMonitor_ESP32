...
********************************************************************************
    ...
    File info:
        ...
        Project File: CANopenMonitor.xdd
        File Version: 1

        Created:      10/4/2024 3:12:09 pm
        Created By:   
        Modified:     13/4/2024 1:12:58 pm
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: CANopenMonitor
        Product ID:   
...
typedef struct {
    ...
    uint8_t x1F90_flyingMasterTimingParameters_sub0;
    uint16_t x1F90_flyingMasterTimingParameters[OD_CNT_ARR_1F90];
} OD_RAM_t;
...
#define OD_ENTRY_H1F90 &OD->list[37]
...
#define OD_ENTRY_H1F90_flyingMasterTimingParameters &OD->list[37]
