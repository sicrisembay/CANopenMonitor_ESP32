...
void ui_Configure_screen_init(void)
{
    ...
    ui_Configure_Button_Button1 = lv_btn_create(ui_Configure);
    lv_obj_set_height(ui_Configure_Button_Button1, 60);
    lv_obj_set_width(ui_Configure_Button_Button1, lv_pct(100));
    lv_obj_set_align(ui_Configure_Button_Button1, LV_ALIGN_BOTTOM_MID);
    lv_obj_add_flag(ui_Configure_Button_Button1, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_Configure_Button_Button1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_Configure_Button_Button1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ui_object_set_themeable_style_property(ui_Configure_Button_Button1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ColorTwo);
    ui_object_set_themeable_style_property(ui_Configure_Button_Button1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ColorTwo);

    ui_Configure_Label_Label3 = lv_label_create(ui_Configure_Button_Button1);
    ...
    ui_object_set_themeable_style_property(lv_dropdown_get_list(ui_Configure_Dropdown_Dropdown1),
                                           LV_PART_SELECTED | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR, _ui_theme_color_ColorTwo);
    ui_object_set_themeable_style_property(lv_dropdown_get_list(ui_Configure_Dropdown_Dropdown1),
                                           LV_PART_SELECTED | LV_STATE_DEFAULT, LV_STYLE_BG_OPA, _ui_theme_alpha_ColorTwo);
